...
WHERE id = $userID";
        ...
        while (($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) != NULL) {
            ...
            echo "<span class=\"span3\">Name: </span>{$row1['full_name']}</br>";
            echo "<span class=\"span3\">Address: </span>{$row1['street_address']}</br>";
            echo "<span class=\"span3\">City:</span>{$row1['city']}</br>";
            echo "<span class=\"span3\">Post Code: </span>{$row1['post_code']}</br>";
            echo "<span class=\"span3\">Country: </span>{$row1['country']}</br>";
            echo "<span class=\"span3\">Username: </span>{$row1['username']}</br>";
        }
        mysqli_free_result($result1);
        ?>
        
         <a class="btn btn-success" href="orderSuccess.php">
Proceed to Payment
